...
// VGI: OBJECTE --> Corbes Bezier i BSpline
	...
	GLfloat pas_Corba;					// Increment del paràmetre t per al dibuix de les corbes.

	GLfloat pas_CS;						// Increment del paràmetre t per al dibuix de corbes i superficies.
...
public:
	...
	afx_msg void OnUpdateHurakanBrazos(CCmdUI* pCmdUI);
	afx_msg void OnHurakanBase();
	afx_msg void OnUpdateHurakanBase(CCmdUI* pCmdUI);
	afx_msg void OnHurakanAsientos();
